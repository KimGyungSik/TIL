...
public class Ex11_1 {
    public static void main(String[] args) {
        ...
        ArrayList list2 = new ArrayList(list1.subList(1,4)); // list2 = [4,3,2]
        print(list1, list2);

        //Collection은 인터페이스, Collections는 유틸 클래스
        Collections.sort(list1);// list1과 list2를 정렬
        Collections.sort(list2);
        print(list1,list2); // list1 = 0,1,2,3,4,5 list2 = 2,3,4

        list2.add("B");
        list2.add("C");
        list2.add(3,"A");
        print(list1,list2);  //list2 = 2,3,4,A,B,C

        list2.set(3,"AA");
        print(list1,list2); // list2 = 2,3,4,AA,B,C
